...
====================
Merge
 Recebe como parâmetro uma matriz de pares de inteiros, onde cada um deles representa uma espécie de
 "distância", sendo o 1° dado o "início" e o 2° o "fim". A função encontra intersecções entre os valores
 dos diferentes pares e realiza a união entre eles. Retorna uma nova matriz com as modificações feitas.
====================
*/
